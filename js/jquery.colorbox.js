...
(function ($, document, window) {
	...
	function makeSettings() {
		...
		settings.href = settings.href || $(element).attr('data-colorbox-url'); //Adjusted to work for CAN
	...
	function launch(target) {
        ...
        $related.sort(function(a,b){
          return $(a).data('isotope-order') - $(b).data('isotope-order');
        });
        //END OF ISOTOPE ADJUSTMENT//
